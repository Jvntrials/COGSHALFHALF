      ...
      <form onSubmit={handleSubmit}>
        {activeTab === 'purchase' && (
          <>
            <div className="space-y-4 mb-4">
              <div>
                  <label htmlFor="purchase-date" className="block text-sm font-medium text-secondary mb-1">
                    Purchase Date
                  </label>
                  <Input
                    id="purchase-date"
        ...
        {activeTab === 'sale' && (
          <>
            <div className="space-y-4 mb-4">
              <div>
                <label htmlFor="sale-date" className="block text-sm font-medium text-secondary mb-1">
                  Sale Date
                </label>
                <Input
                  id="sale-date"
